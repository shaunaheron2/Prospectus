...
digraph expanded_flowchart {
  graph [layout = dot, rankdir = TB]

  # Expanded flowchart nodes
  node [shape = box, style = filled, fontsize = 10]
  A [label = "Start", fillcolor = lightblue, style = filled]
  B [label = "Collect Data", fillcolor = lightgreen, style = filled]
  C [label = "Process Data", fillcolor = lightgreen, style = filled]
  D [label = "Feature Engineering", fillcolor = lightcoral, style = filled]
  E [label = "Train Model", fillcolor = lightsalmon, style = filled]
  F [label = "Evaluate Model", fillcolor = lightyellow, style = filled]
  G [label = "Deploy Model", fillcolor = lightcyan, style = filled]
  H [label = "End", fillcolor = lightgrey, style = filled]
